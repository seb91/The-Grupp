...
public class MenuModel implements WindowModel {
    ...
    public MenuModel() {
        ...
        images[0] = new ImageData("./GameTitle.png", 150, y ,500,100,false);
        images[1] = new ImageData("./PlayButton.png", x, y-75,150,50,true );
        images[2] = new ImageData("./OptionsButton.png", x, y-150,150,50,true);
        images[3] = new ImageData("./QuitButton.png", x, y-225,150,50,true);
    }
